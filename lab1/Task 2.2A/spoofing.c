...
int main(int argc, char **argv)
{
  ...
  */
  ...
  //Icmp sequence number use htons to transform big endian, convert from host byte order into network byte order:
  ...
  // Layer II data will be constructed by the kernel IP code, we want to tell kernel that our packet includes the Layer II data already.
